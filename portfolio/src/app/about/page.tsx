                ...
                <div className="flex flex-row lg:px-32 xl:px-64 gap-3 lg:gap-6 mt-16">
                    <div className="flex flex-col gap-3 lg:gap-6 w-[45%]">
                        <h1 className="text-lg self-baseline text-[#f2f2f242]">
                            <span className="text-3xl text-white drop-shadow-[0_0_8px_rgba(255,255,255,0.9)]">
                                •
                            </span>{" "} 
                        About Me</h1>
                        ...
                        <h1 className="text-md md:text-xl 3xl:text-3xl opacity-90 px-12 text-[#f2f2f29b]">Currently, I am purusing a Master's in Computer Science back at CSUF. I can now take the opportunities that I wished I could have taken years ago as my health has significantly improved since then.</h1>
                    ...
                    <div className="flex flex-col gap-3 lg:gap-6 w-[55%] py-32">
                        ...
                        <h1 className="text-md md:text-xl 3xl:text-3xl opacity-90 px-16 text-[#f2f2f29b]">During my time post-graduation, I didn't exactly know what direction I wanted to take my life. The only prior experience I had was a bit of web development and mobile app development.</h1>
                        <h1 className="text-md md:text-xl 3xl:text-3xl opacity-90 px-16 text-[#f2f2f29b] mb-12">While I was still dealing with my health issues, I began to learn web development from the basics. It took a couple months, but I eventually got through the Odin Project (a website that teaches users the basics of web development).</h1>
                        <div className="rounded-[32px] md:p-4 border border-white/10 shadow-[0_40px_80px_rgba(0,0,0,0.5)] transition-all
                        duration-300 hover:-translate-y-1 hover:border-[#5a5a5a] hover:shadow-[0_0_60px_rgba(255,255,255,0.06)]">
                            <div className="relative flex overflow-hidden rounded-3xl bg-[linear-gradient(190deg,#252525,#121212)] border border-[#3d3d3d] shadow-[0_0_40px_rgba(255,255,255,0.03)] w-full">
                                <Image
